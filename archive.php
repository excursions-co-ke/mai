        ...
        <div class="page-name-wrap">
            <div class="ggts-name">
                ...
                <nav class="woocommerce-breadcrumb"><a
                        href="<?php echo home_url('/'); ?>">Home</a>&nbsp;/&nbsp;<?php the_archive_title(); ?></nav>
            </div>
        </div>
    </div>
</header>
                ...
                <main id="main" class="site-main">
                    <div class="blog-section">
                        <ul class="filters blog-filters tour-filter hidden-xs">
                            <li><a href="#" data-filter="*" class="current"><span data-hover="All">All</span></a><span
                                    class="sep">|</span></li>
                            <?php $terms = get_terms([
                                    'taxonomy' => 'category',
                                    'hide_empty' => false,
                            ...
                            <li><a href="#" data-filter=".<?php echo $term->slug; ?>"><span
                                        data-hover="<?php echo $term->name; ?>"><?php echo $term->name; ?></span></a><span
                                    class="sep">|</span></li>
                            <?php endforeach; ?>
                            <?php endif; ?>
                        </ul>
                        ...
                        <ul class="blog-row sorter " style="position: relative; height: 1724.08px;">
                            ...
                            <li class="col-md-12 col-xs-12 post-cont <?php echo $terms_string; ?>"
