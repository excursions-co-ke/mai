									...
									<div id="<?php the_ID(); ?>" <?php post_class(); ?>>
										<div class="entry-content">
											...
											<div id="accordion1" class="panel-group">
												<?php if (have_rows('itinerary')) : ?>
													<div class="panel panel-default">
														<div class="panel-heading"><a class="panel-title accordion-toggle" data-toggle="collapse" href="#tour-plan1">Tour Plan<i class="indicator glyphicon glyphicon-chevron-down pull-right"></i></a>
														</div>
												...
												<?php if (get_field('map')) : ?>
													<div class="panel panel-default">
														<div class="panel-heading"><a class="panel-title accordion-toggle" data-toggle="collapse" href="#map1">Map<i class="indicator glyphicon glyphicon-chevron-down pull-right"></i></a>
														</div>
												...
												<?php if (get_field('video')) : ?>
													<div class="panel panel-default">
														<div class="panel-heading"><a class="panel-title accordion-toggle" data-toggle="collapse" href="#video1">Video<i class="indicator glyphicon glyphicon-chevron-down pull-right"></i></a>
														</div>
											...
											<div id="single-pagination">
												...
												if (!empty($next_post)) : ?>
													<div class="post-next col-md-5 col-md-offset-2 col-sm-offset-2 col-sm-5 col-xs-12 pull-right hvr-reveal ">
														<div class="related-details">
															<h4>
					...
					<div class="modal-body">
						<div class="booking-cf7">
							<div role="form" class="wpcf" id="wpcf7-f5-o1" lang="en-US" dir="ltr">
								...
								<form action="<?php echo home_url("book-now"); ?>" method="POST" class="wpcf7-form" novalidate="novalidate">
									<div class="col-md-12">
												...
												<li class="gg-cf7-wrap">
													<div class="gg-cf7">
														<span class="wpcf7-form-control-wrap number-adults">
															<input type="number" name="items[<?php echo $product->get_id(); ?>]" value="" class="wpcf7-form-control wpcf7-number wpcf7-validates-as-required wpcf7-validates-as-number" min="1" max="<?php the_sub_field('available'); ?>" aria-required="true" aria-invalid="false" /></span><br />
														<label class="input_label"><br />
															<span class="input_label-content"><?php echo $product->get_title(); ?></span><br />
														</label>
													</div>
												</li>
											<?php endwhile; ?>
									...
									<p class="submit-booking">
										<input type="submit" value="Proceed to checkout" class="wpcf7-form-controls wpcf7-submits" />
									</p>
