                    ...
                    <?php if (get_field('from') && (strtotime(get_field('from')) > time())) : ?>
                        <li class="single-project">
                            <div class="ggts-title">
                                <div id="tour-<?php the_ID(); ?>" class="ggts-image-section" style="background-image: url('<?php echo get_the_post_thumbnail_url(); ?>');"></div>
                                <div class="ggts-name">
                                    <h4>
                                            ...
                                            <div class="col-md-3 col-sm-3">
                                                <div class="table">
                                                    <div class="table-cell">
                                                        <button type="button" data-toggle="modal" data-target="#booking-modal<?php the_ID(); ?>" dataTitle="<?php the_title(); ?>" class="btn btn-book icon-book">Book Now</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-sm-3">
                        ...
                        <div class="modal fade" id="booking-modal<?php the_ID(); ?>" tabindex="-1" role="dialog" aria-labelledby="booking-modal<?php the_ID(); ?>Label">
                            <div class="modal-dialog bcf7 container" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                        <h4 class="modal-title" id="booking-modal<?php the_ID(); ?>Label"><?php the_title(); ?></h4>
                                    </div>
