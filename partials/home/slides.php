<section class="gg-section hero ">
    ...
    <div class="visible-only-lg ">
        <form role="search" method="get" class="searchtours animated fadeInUp searchform form-inline"
            ...
            <div class="cont-search container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="budget-max col-md-4">
                                <label for="budget">BUDGET &#36;</label>
                                <input type="number" name="budget" id="budget" min="" placeholder="Ex. 00">
                            </div>
                            <div class="input-group date col-md-4 datetimepicker-from">
                            ...
                            <div class="input-group date col-md-4 datetimepicker-to">
    ...
    <div id="accordion-s-destination" class="panel-group animated fadeInUp ">
        <div class="panel panel-default">
            ...
            <div id="dest-search" class="panel-collapse collapse">
                <form role="search" method="get" class="searchtours searchform form-inline"
                    action="<?php echo home_url('/'); ?>">
                    <div class="cont-search container">
                        <div class="col-md-4 wpd">
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="input-group date col-md-4 datetimepicker-from">
                                    ...
                                    <input type="text" name="from" id="from2" class="form-control"
                                        readonly="readonly" />
                                    <span class="input-group-addon">
                                        <i class="fa fa-calendar"></i>
                                    </span>
