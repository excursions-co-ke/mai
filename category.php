...
<?php get_header(); ?>
<?php if (have_posts()) : ?>
    <header class="post-img-full page-img-header taxonomy" data-type="background" data-speed="10" style="background: url('<?php if (get_field('image', get_queried_object())) { the_field('image', get_queried_object()); } ?>'); background-size: cover; background-position: center;">
                        ...
                        <div class="blog-section">
                            ...
                            <ul class="blog-row sorter " style="position: relative; height: 1724.08px;">
                                <?php while (have_posts()) : the_post(); ?>
                                    ...
                                    <li class="col-md-6 col-xs-12 post-cont <?php echo $terms_string; ?>" style="position: absolute; left: 0px; top: 0px;">
                                        ...
                                        <div class="card blog-post hvr-underline-from-center">
                                            ...
                                            <div class="post-details">
                                                ...
                                                <div class="post-links">
                                                    <a class="simple-link hvr-pop" href="<?php the_permalink(); ?>">Read more</a>
                                                    <span class="comments pull-right"><a href="<?php the_permalink(); ?>#respond"><?php echo get_comments_number(); ?> <i class="fa fa-comment-o"></i></a></span>
