...
// Load plugin classes
include(__DIR__ . '/inc/php-array-replace-recursive.php');
include(__DIR__ . '/class-clientside-setup.php');
include(__DIR__ . '/class-clientside.php');
include(__DIR__ . '/class-clientside-options.php');
include(__DIR__ . '/class-clientside-dashboard.php');
include(__DIR__ . '/class-clientside-toolbar.php');
include(__DIR__ . '/class-clientside-pages.php');
include(__DIR__ . '/class-clientside-menu.php');
include(__DIR__ . '/class-clientside-admin-menu-editor.php');
include(__DIR__ . '/class-clientside-admin-widget-manager.php');
include(__DIR__ . '/class-clientside-admin-column-manager.php');
include(__DIR__ . '/class-clientside-custom-cssjs-tool.php');
include(__DIR__ . '/class-clientside-user.php');
include(__DIR__ . '/class-clientside-error-handler.php');
include(__DIR__ . '/class-clientside-updates.php');
