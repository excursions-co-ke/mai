...
class Clientside {
	...
	// Return wether Admin is enabled
	static function is_enabled() {

		// is_network_admin() is added in case the network site defaults have Admin disabled, it shouldn't be disabled on network admin since that would block access to the config forever.
