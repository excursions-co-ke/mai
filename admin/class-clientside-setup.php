...
class Clientside_Setup
{
	...
	static function action_enqueue_admin_styles()
	{
		...
		// Always-use CSS
		wp_enqueue_style('clientside-admin-css', get_template_directory_uri() . '/admin/css/clientside-admin-1.14.5.css', array(), null);

		// Enqueue the media manager scripts and styles (only when on the Admin general options page)
		...
		if (Clientside::is_themed()) {
			...
			// Theme CSS
			wp_enqueue_style('clientside-theme-css', get_template_directory_uri() . '/admin/css/clientside-admin-theme-1.14.5.min.css', array('clientside-admin-css', 'thickbox'), null);

			// Gutenberg
			// if ( defined( 'GUTENBERG_VERSION' ) ) {
			wp_enqueue_style('clientside-plugin-support-css-gutenberg', get_template_directory_uri() . '/admin/css/plugin-support/clientside-gutenberg-1.14.5.min.css', array('clientside-theme-css'), null);
			// }
			...
			if (Clientside_Options::get_saved_option('enable-plugin-support')) {
				...
				// Global
				wp_enqueue_style('clientside-plugin-support-css', get_template_directory_uri() . '/admin/css/clientside-plugin-support-1.14.5.min.css', array('clientside-theme-css'), null);

				// Visual Composer
				if (defined('WPB_VC_VERSION')) {
					wp_enqueue_style('clientside-plugin-support-css-vc', get_template_directory_uri() . '/admin/css/plugin-support/clientside-vc-1.14.5.min.css', array('clientside-theme-css'), null);
				}

				// bbPress
				if (class_exists('bbPress')) {
					wp_enqueue_style('clientside-plugin-support-css-bbpress', get_template_directory_uri() . '/admin/css/plugin-support/clientside-bbpress-1.14.5.min.css', array('clientside-theme-css'), null);
				}

				// Advanced Custom Fields (free + pro)
				if (class_exists('acf')) {
					wp_enqueue_style('clientside-plugin-support-css-acf', get_template_directory_uri() . '/admin/css/plugin-support/clientside-acf-1.14.5.min.css', array('clientside-theme-css'), null);
				}

				// WooCommerce
				if (class_exists('WooCommerce')) {
					wp_enqueue_style('clientside-plugin-support-css-woocommerce', get_template_directory_uri() . '/admin/css/plugin-support/clientside-woocommerce-1.14.5.min.css', array('clientside-theme-css'), null);
				}

				// WPML
				if (defined('ICL_SITEPRESS_VERSION')) {
					wp_enqueue_style('clientside-plugin-support-css-wpml', get_template_directory_uri() . '/admin/css/plugin-support/clientside-wpml-1.14.5.min.css', array('clientside-theme-css'), null);
				}

				// Formidable Forms
				if (function_exists('load_formidable_forms')) {

					wp_enqueue_style('clientside-plugin-support-css-formidable', get_template_directory_uri() . '/admin/css/plugin-support/clientside-formidable-1.14.5.min.css', array('clientside-theme-css'), null);
				...
				if (defined('LAYERS_VERSION')) {
					wp_enqueue_style('clientside-plugin-support-css-layerswp', get_template_directory_uri() . '/admin/css/plugin-support/clientside-layerswp-1.14.5.min.css', array('clientside-theme-css'), null);
				}

				// Jetpack
				if (defined('JETPACK__VERSION')) {
					wp_enqueue_style('clientside-plugin-support-css-jetpack', get_template_directory_uri() . '/admin/css/plugin-support/clientside-jetpack-1.14.5.min.css', array('clientside-theme-css'), null);
				}

				// Google Analytics Dashboard
				if (defined('GADWP_CURRENT_VERSION')) {
					wp_enqueue_style('clientside-plugin-support-css-gadash', get_template_directory_uri() . '/admin/css/plugin-support/clientside-gadash-1.14.5.min.css', array('clientside-theme-css'), null);
				}

				// HTML Editor Syntax Highlighter
				if (defined('HESH_LIBS')) {
					wp_enqueue_style('clientside-plugin-support-css-htmleditorsyntax', get_template_directory_uri() . '/admin/css/plugin-support/clientside-htmleditorsyntax-1.14.5.min.css', array('clientside-theme-css'), null);
				}

				// WP Statistics
				if (defined('WP_STATISTICS_VERSION')) {
					wp_enqueue_style('clientside-plugin-support-css-wpstatistics', get_template_directory_uri() . '/admin/css/plugin-support/clientside-wpstatistics-1.14.5.min.css', array('clientside-theme-css'), null);
				}

				// Revolution Slider
				if (defined('REVSLIDER_TEXTDOMAIN')) {
					wp_enqueue_style('clientside-plugin-support-css-revslider', get_template_directory_uri() . '/admin/css/plugin-support/clientside-revslider-1.14.5.min.css', array('clientside-theme-css'), null);
				}

				// Divi (builder & theme)
				if (defined('ET_BUILDER_PLUGIN_VERSION') || function_exists('et_get_theme_version')) {
					wp_enqueue_style('clientside-plugin-support-css-divi', get_template_directory_uri() . '/admin/css/plugin-support/clientside-divi-1.14.5.min.css', array('clientside-theme-css'), null);
				}

				// Super Forms
				if (class_exists('SUPER_Forms')) {
					wp_enqueue_style('clientside-plugin-support-css-superforms', get_template_directory_uri() . '/admin/css/plugin-support/clientside-superforms-1.14.5.min.css', array('clientside-theme-css'), null);
				}

				// Elementor
				if (defined('ELEMENTOR_VERSION')) {
					wp_enqueue_style('clientside-plugin-support-css-elementor', get_template_directory_uri() . '/admin/css/plugin-support/clientside-elementor-1.14.5.min.css', array('clientside-theme-css'), null);
				}

				// Enhanced Media Library
				if (function_exists('wpuxss_get_eml_slug')) {
					wp_enqueue_style('clientside-plugin-support-css-eml', get_template_directory_uri() . '/admin/css/plugin-support/clientside-eml-1.14.5.min.css', array('clientside-theme-css'), null);
				}

				// Admin Menu Tree Page View
				if (defined('admin_menu_tree_page_view_VERSION')) {
					wp_enqueue_style('clientside-plugin-support-css-adminmenutreepageview', get_template_directory_uri() . '/admin/css/plugin-support/clientside-adminmenutreepageview-1.14.5.min.css', array('clientside-theme-css'), null);
				}

				// W3 Total Cache
				if (defined('W3TC')) {
					wp_enqueue_style('clientside-plugin-support-css-w3tc', get_template_directory_uri() . '/admin/css/plugin-support/clientside-w3tc-1.14.5.min.css', array('clientside-theme-css'), null);
				}

				// BuddyPress
				if (class_exists('BuddyPress')) {
					wp_enqueue_style('clientside-plugin-support-css-buddypress', get_template_directory_uri() . '/admin/css/plugin-support/clientside-buddypress-1.14.5.min.css', array('clientside-theme-css'), null);
				}

				// WP All Import
				if (defined('WP_ALL_IMPORT_PREFIX')) {
					wp_enqueue_style('clientside-plugin-support-css-wpallimport', get_template_directory_uri() . '/admin/css/plugin-support/clientside-wpallimport-1.14.5.min.css', array('clientside-theme-css'), null);
				}

				// LearnDash
				if (defined('LEARNDASH_VERSION')) {
					wp_enqueue_style('clientside-plugin-support-css-learndash', get_template_directory_uri() . '/admin/css/plugin-support/clientside-learndash-1.14.5.min.css', array('clientside-theme-css'), null);
				}

				// WooCommerce Advanced Bulk Edit (https://wpmelon.com)
				if (class_exists('W3ExAdvancedBulkEditMain')) {
					wp_enqueue_style('clientside-plugin-support-css-advbulkedit', get_template_directory_uri() . '/admin/css/plugin-support/clientside-advbulkedit-1.14.5.min.css', array('clientside-theme-css'), null);
				}

				// Calendarize it! / Options panel
				if (defined('RHC_VERSION')) {
					wp_enqueue_style('clientside-plugin-support-css-calendarizeit', get_template_directory_uri() . '/admin/css/plugin-support/clientside-calendarizeit-1.14.5.min.css', array('clientside-theme-css'), null);
				}
				...
				if (isset($avia_config) && !empty($avia_config)) {
					wp_enqueue_style('clientside-plugin-support-css-enfold', get_template_directory_uri() . '/admin/css/plugin-support/clientside-enfold-1.14.5.min.css', array('clientside-theme-css'), null);
				}
			}
		}
	}
	...
	static function action_enqueue_admin_scripts()
	{
		...
		// Admin theme JS
		wp_enqueue_script('clientside-admin-js', get_template_directory_uri() . '/admin/js/clientside-admin.js', $dependencies, '1.14.5');
	...
	static function action_enqueue_login_styles()
	{
		...
		if (Clientside::is_themed()) {
			wp_enqueue_style('clientside-login-css', get_template_directory_uri() . '/admin/css/clientside-login-1.14.5.min.css', array(), null);
		}
	}
	...
	static function action_enqueue_login_scripts()
	{
		...
		// Only if login page theming is enabled
		if (Clientside::is_themed()) {
			wp_enqueue_script('clientside-login-js', get_template_directory_uri() . '/admin/js/clientside-login.js', array('jquery'), '1.14.5');
		}
	}
	...
	static function action_enqueue_editor_styles()
	{
		...
		// Load the stylesheet
		add_editor_style(get_template_directory_uri() . '/admin/css/clientside-editor-1.14.5.min.css');
	...
	// Hide Admin from plugin list depending on network option
