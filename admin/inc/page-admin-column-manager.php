	...
	<div class="clientside-page-sidebar clientside-page-sidebar--lower">
		...
		<div class="clientside-widget clientside-widget-bordered">
			<div class="inside">
				...
				<p>
					Simply reverting these settings or disabling the Admin plugin will bring everything back.
				</p>
			</div>
		</div>
		...
		<!-- <div class="clientside-widget clientside-widget-bordered">
			<div class="inside">
				<p>
					<?php _e('For instructions on using this tool, visit the Admin Documentation pages:', 'clientside'); ?>
				</p>
				<p>
		...
		<a class="clientside-widget clientside-widget-empty clientside-button-lined clientside-button-large clientside-button-w100p" href="<?php echo Clientside_Pages::get_page_url('clientside-tools'); ?>"><?php _e('All Admin Tools', 'clientside'); ?></a>
	</div>
