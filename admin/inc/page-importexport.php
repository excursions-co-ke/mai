	...
	<div class="clientside-page-sidebar">
		...
		<div class="clientside-widget clientside-widget-bordered">
			<div class="inside">
				...
				<p>
					<?php _e( 'Use this page to import/export Admin settings and configurations. Press Export to generate a text string which can then be imported later or in another installation (also useful for copying settings among a multisite installation).', 'clientside' ); ?>
				</p>
	...
	<div class="clientside-page-content">
		...
		<fieldset>
			<label for="clientside-export-checkbox-options">
				...
				<?php _e( 'Admin Plugin Options', 'clientside' ); ?>
			</label>
			<br>
