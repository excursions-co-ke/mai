	...
	<div class="clientside-page-content">
		...
		<div class="clientside-widget clientside-widget-bordered">
			<ol class="inside clientside-docs-index">
				...
				<li><a href="#clientside-doc-disabling-menu-editor" data-scrollto>How do I disable the Admin Menu Editor?</a></li>
				...
				<li><a href="#clientside-doc-disable-theme" data-scrollto>Using Admin functionality without the theme</a></li>
		...
		<ol>
			<li>First unpack the downloaded zip file and find the Admin zip-file inside.</li>
			<li>Unzip it to extract the Admin plugin folder.</li>
			<li>Upload the folder via FTP to your installation's wp-content/plugins/ folder.</li>
			<li>Then log into the WordPress site where Admin will now appear on the Plugins page.</li>
		...
		<p>
			Additionally, Admin has its own "Settings" button in the plugin listing.
		</p>
		<p>
			Note that the <a class="clientside-internal-link" href="<?php echo Clientside_Pages::get_page_url( 'clientside-options-general' ); ?>">Admin Plugin Options</a> and <a class="clientside-internal-link" href="<?php echo Clientside_Pages::get_page_url( 'clientside-tools' ); ?>">Tools</a> are only available to Administrator type users (specifically users with the "<a href="http://codex.wordpress.org/Roles_and_Capabilities#edit_theme_options" title="About edit_theme_options in the WordPress Codex">edit_theme_options</a>" capability).
		</p>
		...
		<!--
		<p>
			Updating Admin works just like any other plugin. If an update is available a notification will appear in the plugin list or the general WordPress updates page, along with a button to install the update.<br>
		</p>
		-->
		<p>
		...
		<p>
			Visit the "Import/export Settings" tab under Appearance > Admin Theme to find the import/exporting features for the Admin options.
		</p>
		<p>
			Under Export you can choose which sections to export. Hitting the Export button will generate a text string that can be used to import the settings at a later time or in a different Admin installation.
		</p>
		<p>
		...
		<p>
			One of Clientside’s bundled tools is the “<a class="clientside-internal-link" href="<?php echo Clientside_Pages::get_page_url( 'clientside-admin-menu-editor' ); ?>">Admin Menu Editor</a>”. You can find it via the <a class="clientside-internal-link" href="<?php echo Clientside_Pages::get_page_url( 'clientside-tools' ); ?>">Admin Tools page</a>, or in the menu under Tools.
		</p>
		...
		<h3 class="clientside-header-underlined" id="clientside-doc-disabling-menu-editor">
			How do I disable the Admin Menu Editor?
		</h3>
		...
		<p>
			One of Clientside’s bundled tools is the “<a class="clientside-internal-link" href="<?php echo Clientside_Pages::get_page_url( 'clientside-admin-widget-manager' ); ?>">Admin Widget Manager</a>”. You can find it via the <a class="clientside-internal-link" href="<?php echo Clientside_Pages::get_page_url( 'clientside-tools' ); ?>">Admin Tools page</a>, or in the menu under Tools.
		</p>
		...
		<p>
			...
			<span class="description">To hide other page sections throughout the admin areas, also see the <a class="clientside-internal-link" href="<?php echo Clientside_Pages::get_page_url( 'clientside-options-general' ); ?>">Admin Plugin Options</a>.</span>
		</p>
		...
		<p>
			Since version 1.1, Admin puts notifications / alerts inside a Notification Center on the right side of the toolbar. This keeps the page layout uninterrupted, prevents distraction and still provides access to notifications if desired.
		</p>
		<p>
		...
		<p>
			If not appreciated, the Notification Center can be disabled (this is a role-based setting) on the <a class="clientside-internal-link" href="<?php echo Clientside_Pages::get_page_url( 'clientside-options-general' ); ?>">Admin Plugin Options</a> page. Look for the option called "Notification Center" and uncheck the box to disable it.
		</p>
		...
		<p>
			Many other aspects of the interface can be disabled/hidden via the <a class="clientside-internal-link" href="<?php echo Clientside_Pages::get_page_url( 'clientside-options-general' ); ?>">Admin Plugin Options</a>. The options are divided into relevant categories and often can be set independently to apply to specific user roles.
		</p>
		<p>
		...
		<p>
			One of Clientside’s bundled tools is the “<a class="clientside-internal-link" href="<?php echo Clientside_Pages::get_page_url( 'clientside-admin-column-manager' ); ?>">Admin Column Manager</a>”. You can find it via the <a class="clientside-internal-link" href="<?php echo Clientside_Pages::get_page_url( 'clientside-tools' ); ?>">Admin Tools page</a>, or in the menu under Tools.
		</p>
		...
		<p>
			The logo that appears on the login page and in the top-left corner of the admin area can be customized with your own image file. To upload your logo, visit the <a class="clientside-internal-link" href="<?php echo Clientside_Pages::get_page_url( 'clientside-options-general' ); ?>">Admin Plugin Options</a> page and find the "Login page logo image" option and press Upload. This will show the general WordPress Media Manager where you can select an existing file or upload a new one. Select an image and press "Insert into post" to confirm your choice.<br>
		...
		<ul>
			<li>Make sure Admin is network activated or active on the main site.</li>
			<li>In the network admin area (not the main site), find "Admin Theme" in the menu under "Themes".</li>
		</ul>
		<p>
			If you want to end up using Admin on child sites but not the main site, you can safely deactivate Admin on the main site after setting up the network options (if it's not network activated).
		</p>
		...
		<h3 class="clientside-header-underlined" id="clientside-doc-disable-theme">
			Using Admin functionality without the theme
		</h3>

		<p>
			The theming aspect of Admin can be individually disabled without deactivating the plugin. This way you can make use of the functionality changes the plugin provides without changing the WordPress interface styling.
		</p>
		<p>
			To enable/disable Admin theming, find the option "Enable Admin admin theming" on the <a class="clientside-internal-link" href="<?php echo Clientside_Pages::get_page_url( 'clientside-options-general' ); ?>">Admin Plugin Options</a> page. This is a user role specific option.
		</p>
		<p>
		...
		<p>
			One of Clientside’s bundled tools is the “<a class="clientside-internal-link" href="<?php echo Clientside_Pages::get_page_url( 'clientside-custom-cssjs-tool' ); ?>">Custom CSS/JS Tool</a>”. You can find it via the <a class="clientside-internal-link" href="<?php echo Clientside_Pages::get_page_url( 'clientside-tools' ); ?>">Admin Tools page</a>, or in the menu under Tools.
		</p>
		<p>
