...
class Clientside_Pages
{
	...
	// Return (array) the properties of all Admin admin pages
	static function get_pages($page_slug = '')
	{
		...
		$pages['clientside-options-general'] = array_merge(
			...
			array(
				...
				'tab-title' => _x('Settings', 'Option tab title', 'clientside'),
				'title' => _x('Admin Admin Theme Options', 'Option page title', 'clientside'),
		...
		$pages['clientside-options-network'] = array_merge(
			...
			array(
				...
				'menu-title' => _x('Admin Theme', 'Page title in the menu', 'clientside'),
				'title' => _x('Admin Admin Theme Network Options', 'Option page title', 'clientside'),
		...
		if (
			...
			$pages['clientside-tools'] = array_merge(
				...
				array(
					...
					'title' => _x('Tools', 'Option page title', 'clientside'),
		...
		if (!Clientside_Options::get_saved_network_option('network-hide-importexport')) {
			$pages['clientside-importexport'] = array_merge(
				...
				array(
					...
					'title' => _x('Import/Export', 'Option page title', 'clientside'),
	...
	static function display_general_options_page()
	{
		...
		include(__DIR__ . '/inc/page-options-general.php');
	}
	...
	static function display_network_options_page()
	{
		...
		include(__DIR__ . '/inc/page-options-network.php');
	}
	...
	static function display_network_options_site_defaults_page()
	{
		...
		include(__DIR__ . '/inc/page-options-network-site-defaults.php');
	}
	...
	// Output the content of the Admin Tools page
	static function display_tools_page()
	{
		$page_info = self::get_pages('clientside-tools');
		include(__DIR__ . '/inc/page-tools.php');
	}

	// Output the content of the Admin Import/export Settings page
	static function display_importexport_page()
	{
		$page_info = self::get_pages('clientside-importexport');
		include(__DIR__ . '/inc/page-importexport.php');
	}
	...
	static function display_admin_menu_editor()
	{
		...
		include(__DIR__ . '/inc/page-admin-menu-editor.php');
	}
	...
	static function display_admin_widget_manager()
	{
		...
		include(__DIR__ . '/inc/page-admin-widget-manager.php');
	}
	...
	static function display_admin_column_manager()
	{
		...
		include(__DIR__ . '/inc/page-admin-column-manager.php');
	}
	...
	static function display_custom_cssjs_tool()
	{
		...
		include(__DIR__ . '/inc/page-custom-cssjs-tool.php');
	}

	// Output the HTML for page tabs on the Admin pages
