                        ...
                        <p class="info-tour-home">
                            <span class="posted-on">
                                <time class="entry-date published"
                                    datetime="2016-10-13T18:08:17+00:00"><?php the_date('M d, Y'); ?></time>
                                <time class="updated"
                                    datetime="2016-12-10T11:22:17+00:00"><?php the_date('M d, Y'); ?></time>
                            </span>
                        ...
                        <main id="main" class="site-main">
                            ...
                            <div id="single-pagination">
                                ...
                                <div class="post-previous col-md-5 col-sm-5 col-xs-12 pull-left hvr-reveal"
                                    style="background: url('<?php echo get_the_post_thumbnail_url($prev_post->ID); ?>');  background-size: cover; background-position: center;">
                                ...
                                <div class="post-next col-md-5 col-md-offset-2 col-sm-offset-2 col-sm-5 col-xs-12 pull-right hvr-reveal "
                                    style="background: url('<?php echo get_the_post_thumbnail_url($next_post->ID); ?>');  background-size: cover; background-position: center;">
                                    <div class="related-details">
                                        <h4>
